...
module.exports = {
            ...
            list = list + `<div class="comment-box" id="comment-box__setBgColor">
                                <div class="comment-box-top">
                                    ...
                                    <div class="comment-box-top__stuff">
                                        <a href="/board/1/${comments[i].post_id}/${comments[i].comment_id}/comment_update">수정</a>
                                        <form action ="/board/1/${comments[i].post_id}/comment_delete_process" method="post" onsubmit="return confirm('정말로 삭제하시겠습니까?');">
    ...
    postControl: function (isHOT, postId, post) {
        ...
        return `<div class="update-header">
                    ...
                    <span class="update-header__stuff">
                        <a href="/board/1/${postId}/post_update">수정</a>
    ...
    reactionModal: function (postId) {
        ...
        <div id="modal" class="reaction-modal">
            ...
            <input type="submit" class="btn-close" onclick="onClickClose(); location.href='/board/1/${postId}/comment_create';"></input>
        </div>`
    }
