...
module.exports = {
    ...
    commentList: function(categoryId, comments, writer) {
        var list = ``;
        var i = 0;
            ...
            list = list + `<div class="comment-box" id="comment-box__setBgColor">
                                <div class="comment-box-top">
                                    ...
                                    <div class="comment-box-top__stuff">
                                        <a href="/board/${categoryId}/${comments[i].post_id}/${comments[i].comment_id}/comment_update">수정</a>
                                        <form action ="/board/${categoryId}/${comments[i].post_id}/comment_delete_process" method="post" onsubmit="return confirm('정말로 삭제하시겠습니까?');">
    ...
    postControl: function(isHOT, categoryId, postId, post, writer) {
        if (isHOT) {
        ...
        return `<div class="update-header">
                    ...
                    <span class="update-header__stuff">
                        <a href="/board/${categoryId}/${postId}/post_update">수정</a>
                    ...
                    <form action="/board/${categoryId}/${postId}/post_scrap_process" method="post">
    ...
    postFormControl: function(isHOT, categoryId, postId, post) {
        if (isHOT) {
            HOTtitle = `<span class="update-title">실시간 HOT</span>`
        } else {
            HOTtitle = ``;
        ...
        return `
         <form action="/board/${categoryId}/${postId}/post_update_process" method="post">
