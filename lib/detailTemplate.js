...
module.exports = {
    HTML: function (postControl, commentList, commentForm = "", commentsCount = 0, postId) {
        return `<!DOCTYPE html>
        <html lang="en">      
        <head>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" href="https://raw.githack.com/ynawhocodes/BarkHistory/929cc3e2f9f80e7ab2358cdf237b9871ce65b106/public/css/common.css">
        <link rel="stylesheet" href="https://raw.githack.com/ynawhocodes/BarkHistory/929cc3e2f9f80e7ab2358cdf237b9871ce65b106/public/css/board.css">
            ...
            <div class="container">
                <div class="container-inner">
                    ...
                    <div class="reaction">
                        ...
                        <button type="button" class="plus-icon" onclick="location.href='/campus/${postId}/comment_create';onClickPlus();"><img src="https://raw.githack.com/ynawhocodes/BarkHistory/401623c1f0507f09ace99d3c2f3b5a69583c9d53/src/plus.png"></button>
                    </div>
                </div>
        ...
        <div id="modal" class="reaction-modal" style="width: 370px">
            <form>
                ...
                <input type="submit" class="btn-close" onclick="onClickClose();"></input>
            </form>
        </div>
    ...
    commentList: function (comments) {
            ...
            list = list + `<div class="comment-box" id="comment-box__setBgColor">
                                <div class="comment-box-top">
                                    ...
                                    <div class="comment-box-top__stuff">
                                        <a href="/campus/${comments[i].post_id}/${comments[i].comment_id}/comment_update">수정</a>
                                        <form action ="/campus/${comments[i].post_id}/comment_delete_process" method="post" onsubmit="return confirm('정말로 삭제하시겠습니까?');">
        ...
        return list;
    }, commentFormList: function (comments) {
        var list = ``;
        var i = 0;
        ...
        return `<div class="update-header">
                    ...
                    <span class="update-header__stuff">
                        ...
                        <form action ="post_delete_process" method="post" onsubmit="return confirm('정말로 삭제하시겠습니까?');">
                            ...
                            <input type="submit" value="삭제" style="margin-right: 10px">
                        </form>
    ...
    commentContainer: function (commentForm, commentList, reactionModal) {
        return `
        <div class="comment-container">
            ${commentForm}
            ${commentList}
