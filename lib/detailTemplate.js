    ...
    <script>
        ...
        <body class="wrap">
            ...
            <div id="modal" class="reaction-modal">
                    ...
                    <input type="image" id="emoji_05" onclick="putEmoji(this.id)" class="emoji" src="https://raw.githack.com/ynawhocodes/BarkHistory/401623c1f0507f09ace99d3c2f3b5a69583c9d53/emoji/what.png">
                    <input type="submit" class="btn-close" onclick="onClickClose(); location.href='/campus/${post[0].post_id}/comment_create'"></input>
            </div>
