...
CREATE TABLE `scrap` (
  ...
  KEY `fk_user_has_post_post1_idx` (`post_id`,`category_id`),
  KEY `fk_user_has_post_user1_idx` (`user_id`),
  CONSTRAINT `fk_user_has_post_post1` FOREIGN KEY (`post_id`, `category_id`) REFERENCES `post` (`post_id`, `category_id`),
