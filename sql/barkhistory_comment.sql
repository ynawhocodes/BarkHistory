...
CREATE TABLE `comment` (
  ...
  KEY `fk_comment_emotion1_idx` (`emotion_id`),
  KEY `fk_comment_post1_idx` (`post_id`),
  CONSTRAINT `fk_comment_emotion1` FOREIGN KEY (`emotion_id`) REFERENCES `emotion` (`emotion_id`),
...
-- Dump completed on 2021-11-20 19:06:44
